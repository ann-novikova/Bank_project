...
@pytest.mark.parametrize('account_card_info, expected', [('Visa Platinum 7000792289606361',
...
@pytest.mark.parametrize('account_card_info, expected', [('Мир 1596837868705199',
                                                    'Мир 1596 83** **** 5199'),
                                                   ('счет 646861',
                                                    'Счет **6861')])
...
@pytest.mark.parametrize('date_info, expected', [('2024-03-11T02:26:18.671407',
                                                    '11.03.2024'),
